...
const routes = {
  appPages: [
    ...
    { title: 'Patients', path: '/tabs/patients', icon: peopleOutline },
    { title: 'PatientDetail', path: '/tabs/patient-detail', icon: peopleOutline },
...
const Menu: React.FC<MenuProps> = ({ darkMode, history, isAuthenticated, setDarkMode, menuEnabled }) => {
  ...
  return (
    <IonMenu  type="overlay" disabled={!menuEnabled} contentId="main">
      ...
      <IonLabel color="success">MEDITECH</IonLabel>
  
        <IonList lines="none">
          <IonListHeader>SARS CoV-2 Tracker</IonListHeader>
